...
[4] keys — 근거 조문마다 **민원에 답하는 핵심 문장 하나**. 조문 순서대로, 조문 수와 같은 개수.
    ...
    · **「되나요」를 묻는 민원이면 결론이 담긴 문장**(「…허용될 수 있다」「…하여야 한다」「…분리되어 있을 것」)을 고른다.
      원칙을 늘어놓은 일반 문장(「…조치 수준을 결정한다」)보다 **조건·예외·허용을 말하는 문장**이 답인 경우가 많다.
      실측(2026-09-10): 고시 별표 17 5.2 에서 「타당한 경우, 공용시설 내에 별도의 분리되고 독립된 생산구역에서 제조하는 것은
      허용될 수 있다」가 답인데 「마.」의 일반 문장을 골랐다.
